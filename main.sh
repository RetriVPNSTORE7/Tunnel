...
TIMES="10"
CHATID="6944145269"
KEY="7435285430:AAEOfF0_0u_A_dLES3mw6MqPZvw2yJ_PvXs"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              WELCOME TO SCRIPT               \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
# Valid Script
...
data_ip="https://raw.githubusercontent.com/RetriVPNSTORE7/regip/main/izin"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[2;32mWhatsApp\033[0m wa.me/085158699250"
	echo -e "      \033[2;32mTelegram\033[0m t.me/gratiss1"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/RetriVPNSTORE7/regip/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/RetriVPNSTORE7/regip/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/RetriVPNSTORE7/regip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/RetriVPNSTORE7/Tunnel/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/QuinStore/regip/main/izin | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/QuinStore/regip/main/izin | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/gratiss1"},{"text":"Contack","url":"https://wa.me/6285158699250"}]]}'
...
wget raw.githubusercontent.com/QuinStore/scpremium/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd
apt install git -y
git clone https://github.com/QuinStore/noobzvpn.git
cd noobzvpn/
chmod +x install.sh
./install.sh
...
wget https://raw.githubusercontent.com/QuinStore/scpremium/main/Cfg/m-noobz 
